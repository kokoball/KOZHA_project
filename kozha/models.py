...
from kozha import db, login_manager
...
tags = db.Table('tags',
                ...
                db.Column('hashtag_id', db.Integer, db.ForeignKey(
...
class Post(db.Model):
    ...
    style = db.Column(db.String(30), nullable=False, default='베이직')
    tags = db.relationship('Hashtag', secondary=tags,
                           backref=db.backref('tagging', lazy='dynamic'))
    content_img = db.Column(
        db.String(20), nullable=False, default='dummy_post.jpg')
