...
// 이미지 로딩
let image_list1 = [
    "{{ url_for('static', filename='images/worldcup/vs1_1.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs1_2.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs2_1.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs2_2.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs3_1.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs3_2.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs4_1.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs4_2.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs5_1.jpg') }}",
    "{{ url_for('static', filename='images/worldcup/vs5_2.jpg') }}"
    ];
